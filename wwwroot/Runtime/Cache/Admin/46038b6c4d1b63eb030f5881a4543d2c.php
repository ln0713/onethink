...
<body>
	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
		<div class="form-item">
			...
			<div class="controls">
				<input type="text" class="text input-large" name="sale_name" value="<?php echo ((isset($info["sale_name"]) && ($info["sale_name"] !== ""))?($info["sale_name"]):''); ?>">
			</div>
		</div>
		<div class="form-item cf">
			<label class="item-label">价格</label>
			<div class="controls">
				<input type="text" class="text input-large" name="sale_price" value="<?php echo ((isset($info["sale_price"]) && ($info["sale_price"] !== ""))?($info["sale_price"]):''); ?>">&nbsp;
				单位：
				<select style="width: 200px;" name="sale_unit">
					<option value="1" <?php echo $info[sale_unit] == 1 ? 'selected' : '' ;?>>元/月</option>
					<option value="2" <?php echo $info[sale_unit] == 2 ? 'selected' : '' ;?>>万元</option>
				</select>
			</div>
		</div>
		<div class="form-item">
			...
			<div class="controls">
				<select style="width: 200px;" name="sale_type">
					<option value="1" <?php echo $info[sale_type]==1 ? 'selected ' : '' ;?>>出租</option>
					<option value="2" <?php echo $info[sale_type]==2 ? 'selected ' : '' ;?>>销售</option>
				</select>
			</div>
		</div>
		<div class="form-item">
			...
			<div class="controls">
				<input type="text" class="text input-large" name="sale_time" value="<?php echo ((isset($info["sale_time"]) && ($info["sale_time"] !== ""))?($info["sale_time"]):''); ?>">
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">联系电话</label>
			<div class="controls">
				<input type="text" class="text input-large" name="sale_tel" value="<?php echo ((isset($info["sale_tel"]) && ($info["sale_tel"] !== ""))?($info["sale_tel"]):''); ?>">
			</div>
		</div>
		<div class="form-item cf">
			<div class="controls">
				...
				<div class="upload-img-box">
					<div class="upload-pre-item"><img src="<?php echo ((isset($info["logo"]) && ($info["logo"] !== ""))?($info["logo"]):''); ?>"/></div>
				</div>
			</div>
